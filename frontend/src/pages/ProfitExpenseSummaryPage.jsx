    ...
    <div className="space-y-6" data-testid="profit-expense-summary-page">
      ...
      {loading ? (
        ...
        <div className="space-y-6">
          ...
          <Card className="border-purple-200">
            ...
            <CardContent>
              <div className="flex items-end justify-between">
                <div>
                  <p className="text-3xl font-bold text-purple-600" data-testid="gross-profit-value">{formatCurrency(data.gross_profit)}</p>
          ...
          {/* Total Expenses + Damage Loss + Net Profit */}
                  ...
                  <table className="w-full text-sm">
                    <thead>
                      <tr className="border-b bg-muted/40">
                        ...
                        <th className="text-right py-2.5 px-3 font-medium text-muted-foreground">Gross Profit</th>
                        ...
                        <th className="text-right py-2.5 px-3 font-medium text-muted-foreground">Day by Day</th>
                      </tr>
                    </thead>
                    <tbody>
                      {(() => {
