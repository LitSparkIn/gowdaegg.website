...
class SaleReportSubmitRequest(BaseModel):
    ...
    food_expense: float = Field(default=0, ge=0, description="Food Expense")
    diesel_expense: float = Field(default=0, ge=0, description="Diesel Expense")
    other_expense: float = Field(default=0, ge=0, description="Other Expense")
