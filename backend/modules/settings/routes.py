...
async def get_settings(
    ...
    response = SettingsResponse(
        ...
        whatsapp_phone_number_id=settings.get("whatsapp_phone_number_id", "109780805521902"),
        whatsapp_template_id=settings.get("whatsapp_template_id", "gowda_egg_sale_receipt"),
...
async def update_settings(
    ...
    response = SettingsResponse(
        ...
        whatsapp_phone_number_id=updated_settings.get("whatsapp_phone_number_id", "109780805521902"),
        whatsapp_template_id=updated_settings.get("whatsapp_template_id", "gowda_egg_sale_receipt"),
